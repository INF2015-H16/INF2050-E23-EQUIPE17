...
public class TestStatistiques {
    ...
    public void testCalculerEtatParClientMax() {
        ...
        double etatParClientMaxActuel = statistiques.optDouble("l’état par client maximal retourné pour un" +
                " client: ", 0.0);
    ...
    public void testCalculerOccurrencesEtatParClient() {
        ...
        int etatEntreMinMaxActuel = statistiques.optInt("Le nombre d'etats par client entre 1000 et 10000 " +
                "est de : ");
    ...
    public void testCalculerInterventionsParTypeEmploye_Type0() {
        ...
        int interventionsType0Actuelles = statistiques.optInt("Le nombre d'interventions pour les employes de" +
                " type 0 est de :", 0);
    ...
    public void testCalculerInterventionsParTypeEmploye_Type1() {
        ...
        int interventionsType1Actuelles = statistiques.optInt("Le nombre d'interventions pour les employes de" +
                " type 1 est de :", 0);
    ...
    public void testCalculerInterventionsParTypeEmploye_Type2() {
        ...
        int interventionsType2Actuelles = statistiques.optInt("Le nombre d'interventions pour les employes de" +
                " type 2 est de :", 0);
